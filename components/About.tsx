    ...
    <section id="about" className="py-32 bg-zinc-950 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-20 items-center">
        ...
        <motion.div
          ...
          transition={{ duration: 0.8 }}
        >
          <span className="text-orange-500 font-bold uppercase tracking-[0.4em] text-xs">Passione Pugliese</span>
          ...
          <p className="text-zinc-400 text-xl leading-relaxed mb-12 font-medium">
            Situato nel cuore pulsante di Vallecrosia Alta, il nostro ristorante nasce dall'amore per le radici pugliesi e l'arte della macelleria. Ogni taglio di carne viene selezionato personalmente dal nostro Chef Macellaio.
          </p>
          ...
          <div className="space-y-10">
            ...
            <div className="flex items-start gap-6 group">
              ...
              <div>
                <h4 className="font-black text-2xl mb-2 uppercase tracking-tight">Cucina Pugliese</h4>
                <p className="text-zinc-500 text-base leading-relaxed max-w-sm">I sapori del sud incontrano la tecnica del barbecue moderno in un connubio unico.</p>
              </div>
            </div>
          </div>
        </motion.div>
